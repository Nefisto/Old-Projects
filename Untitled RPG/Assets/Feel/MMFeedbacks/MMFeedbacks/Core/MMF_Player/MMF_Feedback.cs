    ...
    public abstract class MMF_Feedback
    {
        ...
        public virtual void CacheRequiresSetup()
        {
            ...
            if (_requiresSetup
                ...
                && AutomatedTargetAcquisition != null
        ...
        protected virtual GameObject FindAutomatedTargetGameObject()
            => MMFeedbackTargetAcquisition.FindAutomatedTargetGameObject(AutomatedTargetAcquisition, Owner,
        ...
        protected virtual T FindAutomatedTarget<T>()
            => MMFeedbackTargetAcquisition.FindAutomatedTarget<T>(AutomatedTargetAcquisition, Owner,
                _indexInOwnerFeedbackList);
        ...
        protected virtual float ApplyDirection (float normalizedTime)
            => NormalPlayDirection ? normalizedTime : 1 - normalizedTime;
