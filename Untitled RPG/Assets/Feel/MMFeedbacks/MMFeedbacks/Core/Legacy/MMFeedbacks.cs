...
namespace MoreMountains.Feedbacks
{
    ...
    public class MMFeedbacks : MonoBehaviour
    {
        ...
        public virtual float GetTime() => PlayerTimescaleMode == TimescaleModes.Scaled ? Time.time : Time.unscaledTime;

        public virtual float GetDeltaTime()
            => PlayerTimescaleMode == TimescaleModes.Scaled ? Time.deltaTime : Time.unscaledDeltaTime;
        ...
        public virtual async Task PlayFeedbacksTask (Vector3 position, float feedbacksIntensity = 1.0f,
        ...
        public virtual float ApplyTimeMultiplier (float duration)
            => duration * Mathf.Clamp(DurationMultiplier, _smallValue, float.MaxValue);
