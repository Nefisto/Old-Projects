                ...
                case 0:
                    ...
                    else
                    {
                        ...
                        for (int i = 0; i < lvTarget.listItems.Count; i++)
                        {
                            ...
                            if (string.IsNullOrEmpty(lvTarget.listItems[i].itemTitle) == true)
                            {
                                lvTarget.listItems[i].isExpanded = EditorGUILayout.Foldout(
                                    lvTarget.listItems[i].isExpanded, "Item #" + i.ToString(), true, foldoutStyle);
                            }
                            else
                            {
                                lvTarget.listItems[i].isExpanded = EditorGUILayout.Foldout(
                            ...
                            if (lvTarget.listItems[i].isExpanded)
                            {
                                ...
                                lvTarget.listItems[i].row0.usePreferredWidth =
                                    EditorGUILayout.Toggle("Use Preferred Width",
                                        lvTarget.listItems[i].row0.usePreferredWidth);
                                if (lvTarget.listItems[i].row0.usePreferredWidth == true)
                                {
                                ...
                                if (rowCount.enumValueIndex > 0)
                                {
                                    ...
                                    lvTarget.listItems[i].row1.usePreferredWidth =
                                        EditorGUILayout.Toggle("Use Preferred Width",
                                            lvTarget.listItems[i].row1.usePreferredWidth);
                                    if (lvTarget.listItems[i].row1.usePreferredWidth == true)
                                    {
                                ...
                                if (rowCount.enumValueIndex > 1)
                                {
                                    ...
                                    lvTarget.listItems[i].row2.usePreferredWidth =
                                        EditorGUILayout.Toggle("Use Preferred Width",
                                            lvTarget.listItems[i].row2.usePreferredWidth);
                                    if (lvTarget.listItems[i].row2.usePreferredWidth == true)
                                    {
