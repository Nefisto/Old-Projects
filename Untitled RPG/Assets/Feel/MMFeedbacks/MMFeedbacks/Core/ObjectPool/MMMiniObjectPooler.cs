    ...
    public class MMMiniObjectPooler : MonoBehaviour
    {
        ...
        protected virtual void CreateWaitingPool()
        {
            ...
            else
            {
                ...
                SceneManager.MoveGameObjectToScene(newPool, gameObject.scene);
        ...
        public static string DetermineObjectPoolName (GameObject gameObjectToPool) => gameObjectToPool.name + "_pool";
