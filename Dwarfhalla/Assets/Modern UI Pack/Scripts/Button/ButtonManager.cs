...
namespace Michsky.MUIP
{
        ...
        IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        ...
        public void OnPointerEnter (PointerEventData eventData)
        {
            ...
            if (enableButtonSounds == true && useHoverSound == true && soundSource != null)
            {
        ...
        public void UpdateUI()
        {
            ...
            if (normalCG != null && isInteractable == true)
            {
                normalCG.alpha = 1;
            }
            ...
            else if (isInteractable == true && disabledCG.alpha == 1)
            {
                StartCoroutine("SetNormal");
            }
