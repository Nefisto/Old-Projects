    ...
    public class MMFeedbackFlash : MMFeedback
    {
        ...
        protected override void CustomPlayFeedback (Vector3 position, float feedbacksIntensity = 1.0f)
        {
            ...
            MMFlashEvent.Trigger(FlashColor, FeedbackDuration * intensityMultiplier, FlashAlpha, FlashID,
                ChannelData(Channel), Timing.TimescaleMode);
        }
        ...
        protected override void CustomStopFeedback (Vector3 position, float feedbacksIntensity = 1)
        {
            ...
            MMFlashEvent.Trigger(FlashColor, FeedbackDuration, FlashAlpha, FlashID, ChannelData(Channel),
                Timing.TimescaleMode, true);
        }
    }
}